          ...
          post: function postLink(scope, iElement, iAttrs, ngModel) {
            ...
            if (ngModel) {
              ...
              ngModel.$render = function () {
                ...
                setTimeout(function() { codeMirror.setValue(safeViewValue) }, 0);
              };
              ...
              codeMirror.on('change', function (instance) {
                ...
                if (newValue !== ngModel.$viewValue) {
                  ...
                  // and it needs to be wrapped in a setTimeout to guarantee $apply happens outside an in-progress $digest
                  setTimeout(fn, 0);
                }
              });
            }
